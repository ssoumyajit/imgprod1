...
SECRET_KEY = 'qh9v&u5)0s74xdku*4rn-ii=g$sx3gg4mdutealvnkstp-nt(z'
...
REST_USE_JWT = True
JWT_AUTH_COOKIE = 'inmygroove_auth'
...
ACCOUNT_EMAIL_VERIFICATION = 'none'  # 'mandatory' for verification
